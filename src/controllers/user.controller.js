...
const registerUser = asyncHandler ( async (req , res) =>{
    ...
    // remove passwors and refresh token field from response
...
const updateUserAvatar = asyncHandler ( async(req , res )=>{
   ...
   //need to delete old avatar using link of old avatar from user from database and delete using cloudinary functions..
